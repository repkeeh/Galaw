...
public class actStressHeal1 extends AppCompatActivity {
    ...
    StressText S08 = new StressText(R.drawable.b1,"Tugas demi tugas yang datang silih berganti");
    StressText S09 = new StressText(R.drawable.b2,"Teman yang membuatmu gelisah");
    StressText S10 = new StressText(R.drawable.b3,"Perkatakaan yang tidak mengenakan dihati");
    StressText S11 = new StressText(R.drawable.b4,"Dijauhi orang tersayangg");
    StressText S12 = new StressText(R.drawable.b5,"Tuntutan yang diberikan orang tuamu yang terlalu berat bagimu");
    StressText S13 = new StressText(R.drawable.b6,"Kamu telah melakukan yang terbaik untuk melakukan itu semua");
    StressText S14 = new StressText(R.drawable.b7,"Kemauan dunia, yang dapat membuat hari menjadi sendu");
    StressText S15 = new StressText(R.drawable.b1,"Kamu patut mengapresiasi dan berbangga hati");
    StressText S16 = new StressText(R.drawable.b2,"Kenapa? Kamu sudah melakukan yang terbaik hingga detik ini");
    StressText S17 = new StressText(R.drawable.b3,"Terlalu besar usahamu hingga lupa dirimu perlu istirahat");
    StressText S18 = new StressText(R.drawable.b4,"Tenanglah, tidak apa");
    ...
    StressText S23 = new StressText(R.drawable.b2, "Waktu ku disini sudah hampir habis");
    StressText S24 = new StressText(R.drawable.b3,"Dunia terus bergerak maju dan kita harus kembali");
    StressText S25 = new StressText(R.drawable.b4,"Sepertinya aku juga harus balik ke duniaku sendiri");
    StressText S26 = new StressText(R.drawable.b5,"Tapi ini bukan terakhir kali kita akan bertemu");
    StressText S27 = new StressText(R.drawable.b6,"Jika kamu merasa dunia kembali tidak terkendali dan membuatmu tertekan, tolong kembali kesini");
    StressText S28 = new StressText(R.drawable.b7, "Aku selalu disini jika kalau kamu butuh. aku ingin memberi saran. Coba untuk mencari tahu keadaanmu, apa yang dapat menimbulkannya, dan lain-lain");
    StressText S29 = new StressText(R.drawable.b1,"Nanti kalau butuh aku lagi, tolong kesini ya");
    StressText S30 = new StressText(R.drawable.b2,"Baik aku pamit dulu. terima makasih sudah ada di ruang ini");
    StressText S31 = new StressText(R.drawable.b3,"Senang bisa bertemu, sampai jumpa!");
