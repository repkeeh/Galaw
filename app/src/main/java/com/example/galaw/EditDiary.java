        ...
        saveEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(nTitle.isEmpty() || nContent.isEmpty()){
                    Toast.makeText(EditDiary.this, "Can not Save note with Empty Field.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                docref.update(note).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(EditDiary.this, "Note Saved.", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(EditDiary.this, "Error, Try again.", Toast.LENGTH_SHORT).show();
