...
public class DiaryHome extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Query query = fStore.collection("notes").document(user.getUid()).collection("myNotes").orderBy("Judul", Query.Direction.DESCENDING);
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                docRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(DiaryHome.this, "Error in Deleting Note.", Toast.LENGTH_SHORT).show();
                                    }
                                });
                                return false;
                            }
